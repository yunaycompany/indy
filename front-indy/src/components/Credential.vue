<template>
  <main class="main main-cards">
    <b-alert show>Crear Defincion de Credencial</b-alert>
    <div class="card mb-2">
    ...
    <b-alert show>Crear Oferta de Credencial</b-alert>
    <div class="card">
      <b-form @submit="onSubmit" v-if="show">
        <b-form-group
          id="schemaName"
    ...
    <b-alert show>Oferta de Credencial</b-alert>
    <div class="card">
       <pre class="m-0" v-if="schema.credOffer">{{ schema.credOffer }}</pre>
    </div>
  </main>
</template>
